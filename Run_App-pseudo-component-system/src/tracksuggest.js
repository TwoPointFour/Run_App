...
//Get data from the database on the previous training results.

// Once data arrives, populate the training history with track.js

// Once data arrives, pass the data into the workout scorer function and generate new training

// Once new training is generated, insert the HTML based on the tempate in the getTrainingPlan function

// Update the URL of the Proceed to Training Button such that the URL Paramas will be used to automatically preset the training timer.

const generateBtn = document.querySelector(".generateTraining");
// console.log(getTrainingPlan("e"));
generateBtn.addEventListener("click", function () {
  const newTraining = document.querySelector(".newTraining");
  newTraining.insertAdjacentHTML(
    "beforeend",
    `        <div class="col-lg-8 suggestCard">
  <div class="row suggestCardHead">
    <div class="col-lg-12">
      <h4 class="text-start head4 mt-1">
        <span class="align-middle infoChip me-3">Next Training</span>
        Distance Interval Training 
      </h4> 
    </div>
  </div>
